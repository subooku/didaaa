...
run_static_checks() {
    ...
    "${CC:-cc}" -std=c11 -Wall -Wextra -Werror -Imain \
        tests/test_cw_morse.c main/cw_morse.c \
        -o "${test_dir}/test_cw_morse"
    "${test_dir}/test_cw_morse"
    "${CC:-cc}" -std=c11 -Wall -Wextra -Werror -Imain \
        tests/test_cw_proto.c main/cw_proto.c \
        -o "${test_dir}/test_cw_proto"
    "${test_dir}/test_cw_proto"
